...
public class RegisterPatient {
     ...
     */
    public static JPanel getPanel(final JButton trigger){
        ...
        //
        final JTextField title, forename,
                surname, dob, contact,
        ...
        int colSize = 15;
        title.setColumns(colSize);
        forename.setColumns(colSize);
        surname.setColumns(colSize);
        dob.setColumns(colSize);
